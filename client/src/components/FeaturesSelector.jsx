        ...
        <div className="mb-3">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3  my-3 gap-3">
                <div className='flex border py-2 px-4 items-center gap-1 rounded-lg'>
                    <input type="checkbox" className='mr-2' value="Wifi" onChange={handleCheckboxes} />
                ...
                <div className='flex border py-2 px-4 items-center gap-1 rounded-lg'>
                    <input type="checkbox" className='mr-2' value="Parking" onChange={handleCheckboxes} />
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                ...
                <div className='flex border py-2 px-4 items-center gap-1 rounded-lg'>
                    <input type="checkbox" className='mr-2' value="TV" onChange={handleCheckboxes} />
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                ...
                <div className='flex border py-2 px-4 items-center gap-1 rounded-lg'>
                    <input type="checkbox" className='mr-2' value="Radio" onChange={handleCheckboxes} />
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                ...
                <div className='flex border py-2 px-4 items-center gap-1 rounded-lg'>
                    <input type="checkbox" className='mr-2' value="Pets" onChange={handleCheckboxes} />
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                ...
                <div className='flex border py-2 px-4 items-center gap-1 rounded-lg'>
                    <input type="checkbox" className='mr-2' value="Elevator" onChange={handleCheckboxes} />
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
